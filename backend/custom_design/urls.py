...
from .views import create_custom_design, confirm, cancel,details, list_searching_printer_designs, loguedUser, update_design_status, details_to_printer, custom_designs_request
