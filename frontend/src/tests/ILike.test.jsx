...
describe("I Like tests", () => {
  ...
  //     token = (
  //       await (await login(messages.token.user, messages.token.user)).json()
  //     ).token;
  //     tokenFriend = (
  //       await (await login(messages.token.friend, messages.token.friend)).json()
  //     ).token;
