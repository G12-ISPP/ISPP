...
class Opinion extends Component {
  ...
  toggleForm = () => {
    if (this.state.isAuthenticated) {
      ...
      this.setState({
        errors: { login: "Debes iniciar sesión para agregar una opinión." },
      });
    }
  };
    ...
    return (
      <div className="new-opinion-container">
        <Button
          ...
          text={showForm ? "Ocultar formulario" : "Añadir opinión"}
        ...
        {errors.login && (
          <div className="opinion-login-error">
            ...
            <Button
              type={BUTTON_TYPES.LARGE}
              style="display: flex; aling-content: center;"
              text="Iniciar sesión"
              path="/login"
            />
          </div>
          ...
          <div className="opinion-form-container">
            <form className="opinion-form" onSubmit={this.handleSubmit}>
              <div className="opinion-form-group">
                <label htmlFor="score" className="opinion-form-group-title">
                  Puntuación
                </label>
                <input
                  type="number"
                ...
                />
                {errors.score && (
                  <span className="opinion-error-text">{errors.score}</span>
                )}
              </div>
              <div className="opinion-form-group">
                <label
                  htmlFor="description"
                  className="opinion-form-group-title"
                >
                  Descripción
                </label>
                <textarea
              ...
              {errors.server && (
                <span className="opinion-error-text">{errors.server}</span>
              )}
              <Button
                type={BUTTON_TYPES.LARGE}
