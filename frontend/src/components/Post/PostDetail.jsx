...
export default function PostDetail(props) {
        ...
        if (idPost) {
            ...
            getComments(idPost)
                ...
                .then(async (data) => {
                    ...
                    const commentsWithUsernames = await Promise.all(commentsWithUsernamesPromises);
    ...
    return (
        <div className="post-detail-details-page">
                ...
                <div className="right-post-detail-container">
                    <div className="post-detail-info-container">
                        ...
                        <div className="post-detail-info-owner">
                            {post.users &&
                                <ProfileIcon name={post.username} onClick={post.users} showScore="False"
                                             userId={post.users}/>}
                        </div>
            ...
            {wantComment && (<ModalComment setWantComment={setWantComment} postId={idPost}/>)}
                        ...
                        <div key={comment.id} className="post-detail-comment">
                            <div className="post-detail-comment-info">
                                <div className="post-detail-info-user">
                                    <ProfileIcon key={comment.user} name={comment.username}
                                                 onClick={comment.user} showScore="False"
                                                 userId={comment.user}/>
                                </div>
